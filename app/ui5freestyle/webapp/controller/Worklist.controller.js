sap.ui.define(
  ...
  function (BaseController, JSONModel, formatter, Filter, FilterOperator) {
    ...
    return BaseController.extend("ui5freestyle.controller.Worklist", {
      formatter: formatter,
      ...
      _onRouteMatched: function (oEvent) {
        if (this.getView().getModel("controlModel").getData().navigate != "1to2") {
          ...
          this.getView().getModel("controlModel").setProperty("/navigate", "1to2");
        }
      },
